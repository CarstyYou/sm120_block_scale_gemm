...
#include "cute_sm120_gemm/sm120_fused_moe/launch.cuh"
#include "cute_sm120_gemm/sm120_blockscaled/builder.cuh"
#include "cute_sm120_gemm/sm120_blockscaled/kernel_impl.cuh"
#include "cute_sm120_gemm/sm120_blockscaled/launch.cuh"
#include "cute_sm120_gemm/sm120_blockscaled/quantize_mxfp8_for_moe.cuh"
...
static int select_mxfp8_fused_moe_tile_m(
    int total_rows, int shape_n, int shape_k, int num_experts, int num_sms)
{
    int m_per_expert = num_experts > 0
        ? (total_rows + num_experts - 1) / num_experts
        : 0;
    ...
    if (m_per_expert <= 8 ||
        (short_k && m32_tiles < num_sms / 2 && swapab_tiles <= num_sms)) {
        return 8;
    }
...
static int select_plain_m64_or_m128(
    int m_per_expert, int shape_n, int num_experts, int num_sms)
{
...
static int select_mxfp8_plain_moe_tile_m(
    int total_rows, int shape_n, int shape_k, int num_experts, int num_sms)
{
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::gemm_mxfp8_nt_groupwise(void* D, void const* A, void const* B,
                                 int shape_m, int shape_n,
                                 int shape_k, int32_t const* SFA,
                                 int32_t const* SFB, cudaStream_t stream, int granK)
{
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::fused_moe_mxfp8_nt_groupwise_impl(
        ...
        int32_t const* SFA, int32_t const* SFB)
{
    ...
    using KT_M64 = sm120_blockscaled::SM120BlockScaledFusedMoeBuilder<64, 128, 64, 4, GranK, false, true>;
    ...
    auto ptr_SFA = reinterpret_cast<typename KT_M128::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFA));
    auto ptr_SFB = reinterpret_cast<typename KT_M128::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFB));
    auto ptr_D = reinterpret_cast<typename KT_M128::ElementD*>(D);

    int tile_m = select_mxfp8_fused_moe_tile_m(
        total_rows, shape_n, shape_k, num_experts, num_sms);
    if (tile_m == 8) {
        sm120_blockscaled::launch_fused_moe<KT_SWAPAB>(
            ptr_A, ptr_B, ptr_SFA, ptr_SFB, ptr_D, total_rows, shape_n, shape_k,
            num_experts, token_offset, num_sms, stream);
        return;
    }
    if (tile_m == KT_M32::kTileM) {
        sm120_blockscaled::launch_fused_moe<KT_M32>(
            ptr_A, ptr_B, ptr_SFA, ptr_SFB, ptr_D, total_rows, shape_n, shape_k,
            num_experts, token_offset, num_sms, stream);
        return;
    }
    if (tile_m == KT_M64::kTileM) {
        sm120_blockscaled::launch_fused_moe<KT_M64>(
            ptr_A, ptr_B, ptr_SFA, ptr_SFB, ptr_D, total_rows, shape_n, shape_k,
            num_experts, token_offset, num_sms, stream);
        return;
    }
    sm120_blockscaled::launch_fused_moe<KT_M128>(
        ptr_A, ptr_B, ptr_SFA, ptr_SFB, ptr_D, total_rows, shape_n, shape_k,
        num_experts, token_offset, num_sms, stream);
}
...
void CuteSm120Mxfp8GemmRunner<
    ...
    BlockScaleElementType>::gemm_mxfp8_nt_groupwise_impl(void* D, void const* A, void const* B,
                                      int shape_m, int shape_n,
                                      int shape_k, int32_t const* SFA,
                                      int32_t const* SFB, cudaStream_t stream)
{
    using KT_M128 = sm120_blockscaled::SM120BlockScaledBuilder<128, 128, 64, 4, GranK, sm120_common::GemmType::Normal>;
    using KT_M64  = sm120_blockscaled::SM120BlockScaledBuilder<64, 128, 64, 4, GranK, sm120_common::GemmType::Normal>;
    using KT_M32  = sm120_blockscaled::SM120BlockScaledBuilder<32, 128, 128, 4, GranK, sm120_common::GemmType::Normal>;
    using KT_SWAPAB_N8 = sm120_blockscaled::SM120BlockScaledBuilder<128, 8, 128, 4, GranK, sm120_common::GemmType::Normal, true>;
    ...
    auto ptr_SFA_in = reinterpret_cast<typename KT_M128::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFA));
    auto ptr_SFB_in = reinterpret_cast<typename KT_M128::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFB));
    auto ptr_D_in = reinterpret_cast<typename KT_M128::ElementD*>(D);

    int num_sms = sm120_blockscaled::get_num_sms();

    if (shape_m <= 8) {
        sm120_blockscaled::launch_gemm<KT_SWAPAB_N8>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::batch_gemm_mxfp8_nt_groupwise(
        ...
        int shape_n, int shape_k, cudaStream_t stream, int granK)
{
    DISPATCH_GRAN_K(granK, GRAN_K, {
        batch_gemm_mxfp8_nt_groupwise_impl<GRAN_K>(A, ld_a, stride_a, B, ld_b, stride_b,
                                                   D, ld_d, stride_d, SFA, SFB,
                                                   num_groups, shape_m, shape_n, shape_k, stream);
    })
}
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::batch_gemm_mxfp8_nt_groupwise_impl(
        void* A, int ld_a, int stride_a,
        void* B, int ld_b, int stride_b,
        void* D, int ld_d, int stride_d,
        int32_t* SFA, int32_t* SFB,
        ...
        int shape_n, int shape_k, cudaStream_t stream)
{
    using KT_M128 = sm120_blockscaled::SM120BlockScaledBuilder<128, 128, 64, 4, GranK, sm120_common::GemmType::Batched>;
    using KT_M64  = sm120_blockscaled::SM120BlockScaledBuilder<64, 128, 64, 4, GranK, sm120_common::GemmType::Batched>;
    using KT_M32  = sm120_blockscaled::SM120BlockScaledBuilder<32, 128, 128, 4, GranK, sm120_common::GemmType::Batched>;
    using KT_SWAPAB_N8 = sm120_blockscaled::SM120BlockScaledBuilder<128, 8, 128, 4, GranK, sm120_common::GemmType::Batched, true>;
    ...
    if (shape_m <= 8) {
        sm120_blockscaled::launch_bmm<KT_SWAPAB_N8>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::group_gemm_mxfp8_nt_groupwise_masked(
...
{
    DISPATCH_GRAN_K(granK, GRAN_K, {
        group_gemm_mxfp8_nt_groupwise_masked_impl<GRAN_K>(D, A, B, masked_m, num_groups,
                                                          max_m, n, k, stream, SFA, SFB);
    })
}
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::group_gemm_mxfp8_nt_groupwise_masked_impl(
        void* D, void const* A, void const* B, int const* masked_m,
        int num_groups, int max_m, int n, int k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB)
{
    using KT_MASKED = sm120_blockscaled::SM120BlockScaledBuilder<64, 128, 64, 4, GranK, sm120_common::GemmType::MGroupedMasked>;
    ...
    auto ptr_SFA_in = reinterpret_cast<typename KT_MASKED::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFA));
    auto ptr_SFB_in = reinterpret_cast<typename KT_MASKED::SFConfig::ElementSFLoad*>(const_cast<int32_t*>(SFB));
    auto ptr_D_in = reinterpret_cast<typename KT_MASKED::ElementD*>(D);

    int num_sms = sm120_blockscaled::get_num_sms();

    sm120_blockscaled::launch_masked_gemm<KT_MASKED>(
        ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
        max_m, n, k, num_groups, masked_m, num_sms, stream);
}
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::moe_gemm_mxfp8_nt_groupwise(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_experts, int total_rows, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB, int granK, bool is_gated)
{
    DISPATCH_GRAN_K(granK, GRAN_K, {
        if (is_gated) {
            fused_moe_mxfp8_nt_groupwise_impl<GRAN_K>(D, A, B, token_offset,
                                                      num_experts, total_rows,
                                                      shape_n, shape_k, stream, SFA, SFB);
        } else {
            moe_gemm_mxfp8_nt_groupwise_impl<GRAN_K>(D, A, B, token_offset,
                                                     num_experts, total_rows,
                                                     shape_n, shape_k, stream, SFA, SFB);
        }
    })
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::moe_gemm_mxfp8_nt_groupwise_impl(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_experts, int total_rows, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB)
{
    ...
    using KT_SWAPAB_N8  = sm120_blockscaled::SM120BlockScaledBuilder<128,   8, 128, 4, GranK, kGT, /*SwapAB=*/true>;
    ...
    int num_sms = sm120_blockscaled::get_num_sms();
    int tile_m = select_mxfp8_plain_moe_tile_m(
        total_rows, shape_n, shape_k, num_experts, num_sms);
    if (tile_m == 8) {
        sm120_blockscaled::launch_moe_gemm<KT_SWAPAB_N8>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
            total_rows, shape_n, shape_k, num_experts, token_offset, num_sms, stream);
    } else if (tile_m == 32) {
        sm120_blockscaled::launch_moe_gemm<KT_M32>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
            total_rows, shape_n, shape_k, num_experts, token_offset, num_sms, stream);
    } else if (tile_m == 64) {
        sm120_blockscaled::launch_moe_gemm<KT_M64>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
            total_rows, shape_n, shape_k, num_experts, token_offset, num_sms, stream);
    } else {
        sm120_blockscaled::launch_moe_gemm<KT_M128>(
            ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
            total_rows, shape_n, shape_k, num_experts, token_offset, num_sms, stream);
    }
}
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::group_gemm_mxfp8_nt_groupwise_contiguous(
        void* D, void const* A, void const* B, int32_t const* m_indices,
        int num_groups, int m, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB, int granK, bool use_psum_layout)
{
    DISPATCH_GRAN_K(granK, GRAN_K, {
        group_gemm_mxfp8_nt_groupwise_contiguous_impl<GRAN_K>(D, A, B, m_indices, num_groups, m,
                                                              shape_n, shape_k, stream, SFA, SFB,
                                                              use_psum_layout);
    })
}
...
void CuteSm120Mxfp8GemmRunner<
    ElementType, OutElementType, AccumElementType,
    BlockScaleElementType>::group_gemm_mxfp8_nt_groupwise_contiguous_impl(
        void* D, void const* A, void const* B, int32_t const* m_indices,
        int num_groups, int m, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB, bool use_psum_layout)
{
    ...
    if (use_psum_layout) {
        ...
        if (m_per_expert <= 12) {
            sm120_blockscaled::launch_moe_gemm<KT_SWAPAB_N8>(
                ptr_A_in, ptr_B_in, ptr_SFA_in, ptr_SFB_in, ptr_D_in,
                m, shape_n, shape_k, num_groups, m_indices, num_sms, stream);
...
template class CuteSm120Mxfp8GemmRunner<cute::float_e4m3_t,
                                              cute::bfloat16_t, float, cute::float_ue8m0_t>;


template <int GranK>
static void quantize_mxfp8_for_moe_impl(
    void* fp8_output, void* scale_output, void* input, void* token_offset,
    int64_t num_experts, int64_t max_token_num, int64_t size_k, cudaStream_t stream)
{
    ...
    int64_t scale_leading_dim = sm120_common::math::compute_padded_offset(max_token_num, num_experts);
    ...
    auto scale_kernel
        = sm120_blockscaled::quantize_mxfp8_for_moe_kernel_sm120<GranK, __nv_bfloat16, __nv_fp8_e4m3, kWarpsPerBlock>;
    CUTE_CHECK_ERROR(
    ...
    scale_kernel<<<grid, block, smem_size, stream>>>(
        reinterpret_cast<__nv_fp8_e4m3*>(fp8_output),
        reinterpret_cast<int32_t*>(scale_output),
        reinterpret_cast<const __nv_bfloat16*>(input),
        reinterpret_cast<const int32_t*>(token_offset),
        num_experts,
        size_k,
        scale_leading_dim
    );
...
{
    DISPATCH_GRAN_K(granK, GRAN_K, {
        quantize_mxfp8_for_moe_impl<GRAN_K>(fp8_output, scale_output, input, token_offset,
