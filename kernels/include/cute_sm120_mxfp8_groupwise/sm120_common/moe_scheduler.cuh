...
struct MoeScheduler {
    ...
    MoeScheduler(int shape_m_, int shape_n_, int num_groups_,
...
using SelectedMoeScheduler = std::conditional_t<kSwapAB,
    MoeScheduler<TileN, TileM>,
    MoeScheduler<TileM, TileN>>;
