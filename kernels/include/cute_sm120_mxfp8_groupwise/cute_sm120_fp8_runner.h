...
public:
    ...
    virtual void gemm_fp8_nt_groupwise(
        ...
        int scale_granularity_n = 128, int scale_granularity_k = 128) = 0;

    virtual void batch_gemm_fp8_nt_groupwise(
        void* D, void const* A, void const* B,
...
class CuteSm120Fp8GemmRunner
    : public CuteSm120Fp8GemmRunnerInterface
{
public:
    CuteSm120Fp8GemmRunner();
    ~CuteSm120Fp8GemmRunner();

    void gemm_fp8_nt_groupwise(
        void* D, void const* A, void const* B,
        int shape_m, int shape_n, int shape_k,
        float const* scales_a, float const* scales_b,
        cudaStream_t stream, int scale_granularity_m = 1,
    ...
    void batch_gemm_fp8_nt_groupwise(
        void* D, void const* A, void const* B,
        int num_groups, int shape_m, int shape_n, int shape_k,
        float const* scales_a, float const* scales_b,
        cudaStream_t stream, int scale_granularity_m = 1,
    ...
    void group_gemm_fp8_nt_groupwise_masked(
        void* D, void const* A, void const* B, int32_t const* masked_m,
        int num_groups, int max_m, int n, int k, cudaStream_t stream,
        float const* SFA, float const* SFB, int scale_granularity_m = 1,
        int scale_granularity_n = 128, int scale_granularity_k = 128) override;

    void moe_gemm_fp8_nt_groupwise(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k,
        cudaStream_t stream, float const* SFA, float const* SFB,
        int scale_granularity_m = 1, int scale_granularity_n = 128,
...
private:
    void gemm_fp8_nt_groupwise_impl(
        void* D, void const* A, void const* B,
        int shape_m, int shape_n, int shape_k,
        float const* SFA, float const* SFB, cudaStream_t stream);

    void batch_gemm_fp8_nt_groupwise_impl(
        void* D, void const* A, void const* B,
        int num_groups, int shape_m, int shape_n, int shape_k,
        float const* SFA, float const* SFB, cudaStream_t stream);

    void group_gemm_fp8_nt_groupwise_masked_impl(
        void* D, void const* A, void const* B, int32_t const* masked_m,
        int num_groups, int max_m, int n, int k, cudaStream_t stream,
        float const* SFA, float const* SFB);

    void moe_gemm_fp8_nt_groupwise_impl(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k,
        cudaStream_t stream, float const* SFA, float const* SFB);

    void fused_moe_fp8_nt_groupwise_impl(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k,
        cudaStream_t stream, float const* SFA, float const* SFB);

    void group_gemm_fp8_nt_groupwise_contiguous_impl(
        void* D, void const* A, void const* B, int32_t const* m_indices,
        int num_groups, int m, int shape_n, int shape_k, cudaStream_t stream,
