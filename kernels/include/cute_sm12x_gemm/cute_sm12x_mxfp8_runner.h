...
class CuteSm12xMxfp8GemmRunnerInterface
{
public:
    CuteSm12xMxfp8GemmRunnerInterface() {}

    virtual ~CuteSm12xMxfp8GemmRunnerInterface() {}
    ...
    virtual void moe_gemm_mxfp8_nt_groupwise(
...
class CuteSm12xMxfp8GemmRunner
    : public CuteSm12xMxfp8GemmRunnerInterface
{
public:
    ...
    void moe_gemm_mxfp8_nt_groupwise(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA = nullptr, int32_t const* SFB = nullptr, int granK = 128,
...
private:
    ...
    template <int GranK>
    void moe_gemm_mxfp8_nt_groupwise_impl(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB);

    template <int GranK>
    void fused_moe_mxfp8_nt_groupwise_impl(
        void* D, void const* A, void const* B, int32_t const* token_offset,
        int num_groups, int max_shape_m, int shape_n, int shape_k, cudaStream_t stream,
        int32_t const* SFA, int32_t const* SFB);
