...
#include "cute_sm120_gemm/sm120_fused_moe/fp8_kernel_impl.cuh"
#include "cute_sm120_gemm/sm120_fused_moe/mxfp8_kernel_impl.cuh"
                      ...
                      int num_sms, cudaStream_t stream = 0)
{
  ...
  auto args = make_launch_args<KT, Kernel>(ptr_A, ptr_B, ptr_SFA, ptr_SFB, ptr_D, M, 2 * N, K, grouped_layout);
...
void launch_fused_moe(typename KT::ElementA const* ptr_A, typename KT::ElementB const* ptr_B,
                      ...
                      typename KT::ElementD* ptr_D, int M, int N, int K, int num_experts,
                      int32_t const* grouped_layout, int num_sms, cudaStream_t stream = 0)
{
