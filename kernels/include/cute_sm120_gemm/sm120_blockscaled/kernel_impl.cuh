...
#include "cute_sm120_gemm/sm120_blockscaled/sf_mxfp8_tma_load.cuh"
...
struct SM120BlockScaledGemmKernel {
  ...
  to_underlying_arguments(ProblemShape const& problem_shape, Arguments const& args)
  {
    ...
    auto [tma_load_sfa, tma_load_sfb] = utils::make_sf_tma_descriptors<KT>(
        args.ptr_SFA, args.ptr_SFB, M, N, K, num_experts);
